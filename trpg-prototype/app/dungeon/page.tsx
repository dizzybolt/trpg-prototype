...
export default function DungeonPage() {
  ...
  function turnLeft() {
    ...
    addExploreLog(`${directions[nextIndex]} 방향으로 몸을 돌렸다.`)
  }
  ...
  function moveForward() {
    ...
    addExploreLog(`${directions[directionIndex]} 방향으로 전진했다.`)
    ...
    <main className="game-page">
      <div className="game-container">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button onClick={turnLeft} className="game-button">
            ← 좌회전
          </button>

          <button onClick={moveForward} className="game-button-primary">
            ↑ 전진
          </button>

          <button onClick={turnRight} className="game-button">
            우회전 →
          </button>
        </div>
